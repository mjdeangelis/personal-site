...
export default function RUMNExtJsPage() {
  return (
    <div className='pageContainer'>
      ...
      <hr />
      <p>
        CloudWatch RUM (Real User Monitoring) is a powerful tool within the AWS
        suite that allows you to collect client-side metrics and performance
        data.
      </p>
      <p>
        There is enough documentation available on how to add RUM to any React
        application, but if you are using Next.js there are some extra steps in
